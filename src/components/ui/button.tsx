...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none  ",
  {
    variants: {
      variant: {
        default: "bg-black text-primary-foreground hover:bg-main hover:text-white ",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-main hover:text-white",
        outline:
          "border border-black bg-background hover:bg-main hover:text-white hover:border-transparent",
        secondary:
