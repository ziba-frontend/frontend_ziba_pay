...
import { useFetchUserProfile, useLogout, useUpdateProfile } from "@/hooks/useAuth";
import { Skeleton } from "@/components/ui/skeleton";
import { Card, CardContent, CardHeader, CardFooter, CardDescription } from "@/components/ui/card";
import {
  User, Settings, LogOut, Briefcase, Mail, MapPin, PhoneCall, Save, X,
  CreditCard, BarChart2, ExternalLink, FileText, Code, DollarSign, TrendingUp,
  ChevronRight, BookOpen, ToggleLeft, Github
} from "lucide-react";
...
const mockTransactions = [
  { id: "tr_123456", amount: 1250.00, status: "completed", date: "2025-03-28", paymentMethod: "card" },
  { id: "tr_123457", amount: 799.50, status: "completed", date: "2025-03-25", paymentMethod: "bank" },
  { id: "tr_123458", amount: 350.00, status: "pending", date: "2025-03-30", paymentMethod: "card" },
];

const mockStats = {
  totalTransactions: 76,
  successRate: 98.2,
  totalVolume: 12750.50,
  thisMonth: 4950.75,
  lastMonth: 3840.25,
  growthRate: 28.9
};
...
const Account = () => {
  ...
  return (
    <div className="w-full mx-auto pt-6">
      <Tabs defaultValue="profile" onValueChange={setActiveTab} className="mb-6">
        ...
        <TabsContent value="profile" className="space-y-6 mt-6">
          ...
          <Card className="mb-6">
            <CardHeader className="border-b pb-3">
              ...
              <CardDescription>
                Methods you've enabled to receive payments from customers
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-6">
                ...
                <div className="flex items-center justify-between p-3 border rounded-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">ACH and wire transfers</p>
                    </div>
                  </div>
                  <Switch checked={true} />
                </div>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                <p>Transaction fee: 2.9% + $0.30 per successful card charge</p>
            ...
            <CardHeader className="border-b pb-3">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">I'm a developer</span>
            ...
            {isDeveloper ? (
                  ...
                  <div className="border rounded-md p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-sm text-muted-foreground">
                        We'll send notifications to this URL when events occur in your account.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="pt-6 text-center">
                <p className="text-muted-foreground mb-4">
                  Turn on developer mode to access API keys, documentation, and integration tools
                </p>
                <Button onClick={() => setIsDeveloper(true)}>Enable Developer Mode</Button>
              </CardContent>
            )}
          </Card>
        </TabsContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader className="pb-2">
                ...
                <h3 className="text-2xl font-bold">${mockStats.totalVolume.toLocaleString()}</h3>
              </CardHeader>
              <CardContent>
                <div className="flex items-center text-sm text-muted-foreground">
                  <TrendingUp className="h-4 w-4 mr-1 text-green-500" />
                  <span className="text-green-500 font-medium">{mockStats.growthRate}%</span>
            ...
            <Card>
              <CardHeader className="pb-2">
                ...
                <h3 className="text-2xl font-bold">{mockStats.successRate}%</h3>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">${mockStats.thisMonth.toLocaleString()}</span>
                  </div>
                  <Progress value={(mockStats.thisMonth / (mockStats.thisMonth + mockStats.lastMonth)) * 100} className="h-2" />
                  <div className="flex justify-between items-center">
                    <span className="text-sm">Last Month</span>
                    <span className="font-medium">${mockStats.lastMonth.toLocaleString()}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
