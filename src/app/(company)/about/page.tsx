      ...
      <div>
         <div className='flex items-center justify-center gap-6 flex-col container py-6'>
            <h1 className='text-center'>
               We're changing how businesses handle their money with payment
               solutions made just for them. It's like a party for your finances
            </h1>
            <Image
               src={about1}
               alt='about1'
         ...
         <div className='relative py-20 bg-br'>
            ...
            <div className='flex flex-col container items-center justify-center gap-4 mt-20'>
               ...
               <p>
                  We've made these products with care so businesses can grow
                  without limits.
               </p>
            </div>
         </div>
