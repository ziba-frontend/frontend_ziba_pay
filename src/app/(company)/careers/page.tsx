      ...
      <div>
         <div className="flex items-center justify-center flex-col gap-5 mt-12 container py-10">
            ...
            <p className="text-center">
               We&apos;re looking for passionate individuals who are ready to join us
               in this <br /> journey of innovation and growth. If you&apos;re
               driven, creative, and eager to <br />
               make a difference, we want to hear from you!
            </p>
            <Button>Explore Job Openings</Button>
         </div>

         <div className="container flex items-center justify-center p-4 flex-col gap-8">
            <Image
               src={careers1}
               alt="careers"
               className=""
            ...
            <div className="w-full md:w-3/4">
               ...
               <p className="text-center">
                  Embark on a rewarding journey of shaping Africa&apos;s connection
                  to the global payment network. At Fincra, we&apos;re committed to
                  fostering diversity, promoting teamwork, and fostering
                  continuous growth. Join our passionate team and be part of the
                  transformative journey in the world of payments.
               </p>
            </div>
         ...
         <div className=" bg-br relative">
            ...
            <div className="flex flex-col gap-12 container py-20">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 p-2 gap-4 items-center justify-center mx-auto">
                  <div className="flex gap-4 flex-col bg-white p-4 w-5/6 sm:w-[300px] md:w-[320px] lg:w-[380px] h-fit sm:h-[250px]  shadow-sm">
                     <Image
                        src={careers2}
                        alt="health Insurance"
                        width={40}
                        height={40}
                        className="bg-br rounded-full p-2"
                     />
                  ...
                  <div className="flex gap-4 flex-col bg-white p-4 w-5/6 sm:w-[300px] md:w-[320px] lg:w-[380px] h-fit sm:h-[250px]  shadow-sm">
                     ...
                     <p>
                        All team members receive 20 days of paid annual leave.
                     </p>
                  </div>
                  <div className="flex gap-4 flex-col bg-white p-4 w-5/6 sm:w-[300px] md:w-[320px] lg:w-[380px] h-fit sm:h-[250px]  shadow-sm">
                     <Image
                     ...
                     <p>
                        We invest in our people to ensure they can achieve their
                        short, medium, and long term professional goals.
                     </p>
                  </div>
                  <div className="flex gap-4 flex-col bg-white p-4 w-5/6 sm:w-[300px] md:w-[320px] lg:w-[380px] h-fit sm:h-[250px]  shadow-sm">
                     <Image
